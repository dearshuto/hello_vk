fn main() {
    let mut binary = convert_shader(include_str!("res/triangle.fs"), naga::ShaderStage::Fragment);
    ...
    let mut binary = convert_shader(include_str!("res/triangle.vs"), naga::ShaderStage::Vertex);
    let pte = binary.as_mut_ptr() as *mut u8;
